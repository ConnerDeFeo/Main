INSERT INTO users(username,name,phone_number,user_password,session_key)  VALUES ('ab12','Abbott','123','x','x'),('ct12','Costello','234','x','y'),
('mb12','Moe','345','x','z'),('ly12','Larry','456','x','a');
INSERT INTO users(username,name,phone_number,name_last_changed,user_password) VALUES('cy12','Curly','567','2024-01-01 00:00:00','x');
INSERT INTO users(username,name,phone_number,date_created,user_password) VALUES('dm12','DrMarvin','1234','1961-05-16 09:00:00','x');
INSERT INTO users(username,name,phone_number,user_password) VALUES('sl12','spicelover','7067','x'),('pl12','Paul','1609','x');
